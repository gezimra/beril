export const en = {
  ...
  productPage: {
    ...
    ctaReserveInStore: "Reserve in Store",
    ctaInquireWhatsapp: "Inquire on WhatsApp",
  ...
  repairTrack: {
    ...
    howItWorksItems: [
      "Use the repair code from your request confirmation SMS or email.",
    ...
    statusAwaitingDropOff: "Awaiting drop-off",
    statusReceivedInStore: "Received in store",
    ...
    resultRepairCode: "Repair Code",
    resultItem: "Item",
    resultCurrentStatus: "Current Status",
    resultEstimatedCompletion: "Estimated Completion",
    resultPending: "Pending",
  },
  wishlist: {
    title: "Wishlist",
    badge: "Saved Items",
    empty: "Your wishlist is empty. Browse watches and eyewear to save items.",
    browseCatalog: "Browse Catalog",
    remove: "Remove",
    save: "Save",
    saved: "Saved",
    navAria: "Open wishlist",
    itemCount: "saved items",
    toastAdded: "Saved to wishlist",
  ...
  cart: {
    ...
    empty: "Your cart is empty. Browse watches and eyewear to add products.",
    browseWatches: "Browse Watches",
    browseEyewear: "Browse Eyewear",
    remove: "Remove",
    items: "Items",
    subtotal: "Subtotal",
